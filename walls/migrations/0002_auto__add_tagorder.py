...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagOrder'
        db.create_table('walls_tagorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wall', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['walls.Wall'], unique=True)),
            ('text', self.gf('django.db.models.fields.CharField')(default='', max_length=10000, blank=True)),
        ))
        db.send_create_signal('walls', ['TagOrder'])


    def backwards(self, orm):
        # Deleting model 'TagOrder'
        db.delete_table('walls_tagorder')
